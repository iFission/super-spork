...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChickenChopPrice = (ImageButton) findViewById(R.id.ChickenChopButton);
        ...
        Button trial = findViewById(R.id.Trial);
...
//                startActivity(intent);
        ...
        ChickenChopPrice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                price1 = "" + ChickenChopTextView.getText().charAt(19);
...
//        }
        ...
        mfoodRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot foodmenu1 = dataSnapshot.child("Menu001");
                ...
                DataSnapshot foodmenu2 = dataSnapshot.child("Menu002");
